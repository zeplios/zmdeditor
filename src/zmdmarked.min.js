...
/**
 *  printArea Version 2.4.1 Copyright (C) 2013
...
b?e.attr("checked",c(this).is(":checked")):"text"==b||""==b?e.attr("value",c(this).val()):"select"==b?c(this).find("option").each(function(a){c(this).is(":selected")&&c("option",e).eq(a).attr("selected",!0)}):"textarea"==b&&e.text(c(this).val())});return b},getPrintWindow:function(){switch(d.mode){case "iframe":var a=new e.Iframe;return{win:a.contentWindow||a,doc:a.doc};case "popup":return a=new e.Popup,{win:a,doc:a.doc}}},Iframe:function(){var a=d.id,b;try{b=document.createElement("iframe"),document.body.appendChild(b),
...
/*! custom markdown js */
(function(){function k(a){this.tokens=[];this.tokens.links={};this.options=a||n.defaults;this.rules=m.normal;this.options.gfm&&(this.rules=this.options.tables?m.tables:m.gfm)}function h(a,g){this.options=g||n.defaults;this.links=a;this.rules=r.normal;this.renderer=this.options.renderer||new b;this.renderer.options=this.options;if(!this.links)throw Error("Tokens array requires a `links` property.");this.options.gfm?this.rules=this.options.breaks?r.breaks:r.gfm:this.options.pedantic&&(this.rules=r.pedantic)}
function b(a){this.options=a||{}}function f(a){this.tokens=[];this.token=null;this.options=a||n.defaults;this.options.renderer=this.options.renderer||new b;this.renderer=this.options.renderer;this.renderer.options=this.options}function c(a,g){return a.replace(g?/&/g:/&(?!#?\w+;)/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function t(a){return a.replace(/&([#\w]+);/g,function(a,b){b=b.toLowerCase();return"colon"===b?":":"#"===b.charAt(0)?"x"===
b.charAt(1)?String.fromCharCode(parseInt(b.substring(2),16)):String.fromCharCode(+b.substring(1)):""})}function p(a,g){a=a.source;g=g||"";return function d(b,e){if(!b)return new RegExp(a,g);e=e.source||e;e=e.replace(/(^|[^\[])\^/g,"$1");a=a.replace(b,e);return d}}function q(){}function u(a){for(var g=1,b,d;g<arguments.length;g++)for(d in b=arguments[g],b)Object.prototype.hasOwnProperty.call(b,d)&&(a[d]=b[d]);return a}function n(a,g,b){if(b||"function"===typeof g){b||(b=g,g=null);g=u({},n.defaults,
g||{});var d=g.highlight,h,e,m=0;try{h=k.lex(a,g)}catch(l){return b(l)}e=h.length;var v=function(a){if(a)return g.highlight=d,b(a);var e;try{e=f.parse(h,g)}catch(c){a=c}g.highlight=d;return a?b(a):b(null,e)};if(!d||3>d.length)return v();delete g.highlight;if(!e)return v();for(;m<h.length;m++)(function(a){return"code"!==a.type?--e||v():d(a.text,a.lang,function(g,d){if(g)return v(g);if(null==d||d===a.text)return--e||v();a.text=d;a.escaped=!0;--e||v()})})(h[m])}else try{return g&&(g=u({},n.defaults,
g)),f.parse(k.lex(a,g),g)}catch(l){l.message+="\nPlease report this to https://github.com/chjj/marked.";if((g||n.defaults).silent)return"<p>An error occured:</p><pre>"+c(l.message+"",!0)+"</pre>";throw l;}}var m={newline:/^\n+/,code:/^( {4}[^\n]+\n*)+/,fences:q,hr:/^( *[-*_]){3,} *(?:\n+|$)/,heading:/^ *(#{1,6}) *([^\n]+?) *#* *(?:\n+|$)/,nptable:q,lheading:/^([^\n]+)\n *(=|-){2,} *(?:\n+|$)/,blockquote:/^( *>[^\n]+(\n(?!def)[^\n]+)*\n*)+/,list:/^( *)(bull) [\s\S]+?(?:hr|def|\n{2,}(?! )(?!\1bull )\n*|\s*$)/,
html:/^ *(?:comment *(?:\n|\s*$)|closed *(?:\n{2,}|\s*$)|closing *(?:\n{2,}|\s*$))/,def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +["(]([^\n]+)[")])? *(?:\n+|$)/,table:q,paragraph:/^((?:[^\n]+\n?(?!hr|heading|lheading|blockquote|tag|def))+)\n*/,text:/^[^\n]+/,handseq:/^ *`{3}\s*handseq\s+([\s\S]+?)`{3}/,flowchart:/^ *`{3}\s*flowChart\s+([\s\S]+?)`{3}/,katex:/^ *`{3}\s*math\s+([\s\S]+?)`{3}/,mermaid:/^ *`{3}\s([\s\S]+?)`{3}/,bootalert:/^ *:{3}\s*([^\s]+)\s*([\s\S]+?):{3}/,bullet:/(?:[*+-]|\d+\.)/,item:/^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/};
m.item=p(m.item,"gm")(/bull/g,m.bullet)();m.list=p(m.list)(/bull/g,m.bullet)("hr","\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))")("def","\\n+(?="+m.def.source+")")();m.blockquote=p(m.blockquote)("def",m.def)();m._tag="(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b";m.html=p(m.html)("comment",/\x3c!--[\s\S]*?--\x3e/)("closed",/<(tag)[\s\S]+?<\/\1>/)("closing",/<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g,
m._tag)();m.paragraph=p(m.paragraph)("hr",m.hr)("heading",m.heading)("lheading",m.lheading)("blockquote",m.blockquote)("tag","<"+m._tag)("def",m.def)();m.normal=u({},m);m.gfm=u({},m.normal,{fences:/^ *(`{3,}|~{3,})[ \.]*(\S+)? *\n([\s\S]*?)\s*\1 *(?:\n+|$)/,paragraph:/^/,heading:/^ *(#{1,6}) +([^\n]+?) *#* *(?:\n+|$)/});m.gfm.paragraph=p(m.paragraph)("(?!","(?!"+m.gfm.fences.source.replace("\\1","\\2")+"|"+m.list.source.replace("\\1","\\3")+"|")();m.tables=u({},m.gfm,{nptable:/^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/,
table:/^ *\|(.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/});k.rules=m;k.lex=function(a,g){return(new k(g)).lex(a)};k.prototype.lex=function(a){a=a.replace(/\r\n|\r/g,"\n").replace(/\t/g,"    ").replace(/\u00a0/g," ").replace(/\u2424/g,"\n");return this.token(a,!0)};k.prototype.token=function(a,g,b){a=a.replace(/^ +$/gm,"");for(var d,f,e,h,c,l,k;a;){if(e=this.rules.newline.exec(a))a=a.substring(e[0].length),1<e[0].length&&this.tokens.push({type:"space"});if(e=this.rules.handseq.exec(a))a=a.substring(e[0].length),
this.tokens.push({type:"handseq",text:e[1]});else if(e=this.rules.flowchart.exec(a))a=a.substring(e[0].length),this.tokens.push({type:"flowchart",text:e[1]});else if(e=this.rules.katex.exec(a))a=a.substring(e[0].length),this.tokens.push({type:"katex",text:e[1]});else if(e=this.rules.mermaid.exec(a))a=a.substring(e[0].length),this.tokens.push({type:"mermaid",text:e[1]});else if(e=this.rules.bootalert.exec(a))a=a.substring(e[0].length),this.tokens.push({type:"bootalert",style:e[1],text:e[2]});else if(e=
this.rules.code.exec(a))a=a.substring(e[0].length),e=e[0].replace(/^ {4}/gm,""),this.tokens.push({type:"code",text:this.options.pedantic?e:e.replace(/\n+$/,"")});else if(e=this.rules.fences.exec(a))a=a.substring(e[0].length),this.tokens.push({type:"code",lang:e[2],text:e[3]||""});else if(e=this.rules.heading.exec(a))a=a.substring(e[0].length),this.tokens.push({type:"heading",depth:e[1].length,text:e[2]});else if(g&&(e=this.rules.nptable.exec(a))){a=a.substring(e[0].length);c={type:"table",header:e[1].replace(/^ *| *\| *$/g,
"").split(/ *\| */),align:e[2].replace(/^ *|\| *$/g,"").split(/ *\| */),cells:e[3].replace(/\n$/,"").split("\n")};for(l=0;l<c.align.length;l++)/^ *-+: *$/.test(c.align[l])?c.align[l]="right":/^ *:-+: *$/.test(c.align[l])?c.align[l]="center":/^ *:-+ *$/.test(c.align[l])?c.align[l]="left":c.align[l]=null;for(l=0;l<c.cells.length;l++)c.cells[l]=c.cells[l].split(/ *\| */);this.tokens.push(c)}else if(e=this.rules.lheading.exec(a))a=a.substring(e[0].length),this.tokens.push({type:"heading",depth:"="===
e[2]?1:2,text:e[1]});else if(e=this.rules.hr.exec(a))a=a.substring(e[0].length),this.tokens.push({type:"hr"});else if(e=this.rules.blockquote.exec(a))a=a.substring(e[0].length),this.tokens.push({type:"blockquote_start"}),e=e[0].replace(/^ *> ?/gm,""),this.token(e,g,!0),this.tokens.push({type:"blockquote_end"});else if(e=this.rules.list.exec(a)){a=a.substring(e[0].length);h=e[2];this.tokens.push({type:"list_start",ordered:1<h.length});e=e[0].match(this.rules.item);d=!1;k=e.length;for(l=0;l<k;l++)c=
e[l],f=c.length,c=c.replace(/^ *([*+-]|\d+\.) +/,""),~c.indexOf("\n ")&&(f-=c.length,c=this.options.pedantic?c.replace(/^ {1,4}/gm,""):c.replace(new RegExp("^ {1,"+f+"}","gm"),"")),this.options.smartLists&&l!==k-1&&(f=m.bullet.exec(e[l+1])[0],h===f||1<h.length&&1<f.length||(a=e.slice(l+1).join("\n")+a,l=k-1)),f=d||/\n\n(?!\s*$)/.test(c),l!==k-1&&(d="\n"===c.charAt(c.length-1),f||(f=d)),this.tokens.push({type:f?"loose_item_start":"list_item_start"}),this.token(c,!1,b),this.tokens.push({type:"list_item_end"});
this.tokens.push({type:"list_end"})}else if(e=this.rules.html.exec(a))a=a.substring(e[0].length),this.tokens.push({type:this.options.sanitize?"paragraph":"html",pre:!this.options.sanitizer&&("pre"===e[1]||"script"===e[1]||"style"===e[1]),text:e[0]});else if(!b&&g&&(e=this.rules.def.exec(a)))a=a.substring(e[0].length),this.tokens.links[e[1].toLowerCase()]={href:e[2],title:e[3]};else if(g&&(e=this.rules.table.exec(a))){a=a.substring(e[0].length);c={type:"table",header:e[1].replace(/^ *| *\| *$/g,"").split(/ *\| */),
align:e[2].replace(/^ *|\| *$/g,"").split(/ *\| */),cells:e[3].replace(/(?: *\| *)?\n$/,"").split("\n")};for(l=0;l<c.align.length;l++)/^ *-+: *$/.test(c.align[l])?c.align[l]="right":/^ *:-+: *$/.test(c.align[l])?c.align[l]="center":/^ *:-+ *$/.test(c.align[l])?c.align[l]="left":c.align[l]=null;for(l=0;l<c.cells.length;l++)c.cells[l]=c.cells[l].replace(/^ *\| *| *\| *$/g,"").split(/ *\| */);this.tokens.push(c)}else if(g&&(e=this.rules.paragraph.exec(a)))a=a.substring(e[0].length),this.tokens.push({type:"paragraph",
text:"\n"===e[1].charAt(e[1].length-1)?e[1].slice(0,-1):e[1]});else if(e=this.rules.text.exec(a))a=a.substring(e[0].length),this.tokens.push({type:"text",text:e[0]});else if(a)throw Error("Infinite loop on byte: "+a.charCodeAt(0));}return this.tokens};var r={escape:/^\\([\\`*{}\[\]()#+\-.!_>])/,autolink:/^<([^ >]+(@|:\/)[^ >]+)>/,url:q,tag:/^\x3c!--[\s\S]*?--\x3e|^<\/?\w+(?:"[^"]*"|'[^']*'|[^'">])*?>/,link:/^!?\[(inside)\]\(href\)/,reflink:/^!?\[(inside)\]\s*\[([^\]]*)\]/,nolink:/^!?\[((?:\[[^\]]*\]|[^\[\]])*)\]/,
strong:/^__([\s\S]+?)__(?!_)|^\*\*([\s\S]+?)\*\*(?!\*)/,mark:/^==([\s\S]+?)==(?!=)/,underline:/^\+\+([\s\S]+?)\+\+(?!\+)/,em:/^\b_((?:[^_]|__)+?)_|^\*((?:\*\*|[\s\S])+?)\*(?!\*)/,math:/^`\$([^\$]+)\$`/,code:/^(`+)\s*([\s\S]*?[^`])\s*\1(?!`)/,br:/^ {2,}\n(?!\s*$)/,del:q,text:/^[\s\S]+?(?=[\\\+=<!\[_*`]| {2,}\n|$)/,_inside:/(?:\[[^\]]*\]|[^\[\]]|\](?=[^\[]*\]))*/,_href:/\s*<?([\s\S]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/};r.link=p(r.link)("inside",r._inside)("href",r._href)();r.reflink=p(r.reflink)("inside",
r._inside)();r.normal=u({},r);r.pedantic=u({},r.normal,{strong:/^__(?=\S)([\s\S]*?\S)__(?!_)|^\*\*(?=\S)([\s\S]*?\S)\*\*(?!\*)/,em:/^_(?=\S)([\s\S]*?\S)_(?!_)|^\*(?=\S)([\s\S]*?\S)\*(?!\*)/});r.gfm=u({},r.normal,{escape:p(r.escape)("])","~|])")(),url:/^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/,del:/^~~(?=\S)([\s\S]*?\S)~~/,text:p(r.text)("]|","~]|")("|","|https?://|")()});r.breaks=u({},r.gfm,{br:p(r.br)("{2,}","*")(),text:p(r.gfm.text)("{2,}","*")()});h.rules=r;h.output=function(a,g,b){return(new h(g,
b)).output(a)};h.prototype.output=function(a){for(var g="",b,d;a;)if(d=this.rules.escape.exec(a))a=a.substring(d[0].length),g+=d[1];else if(d=this.rules.autolink.exec(a))a=a.substring(d[0].length),"@"===d[2]?(b=":"===d[1].charAt(6)?this.mangle(d[1].substring(7)):this.mangle(d[1]),d=this.mangle("mailto:")+b):d=b=c(d[1]),g+=this.renderer.link(d,null,b);else if(!this.inLink&&(d=this.rules.url.exec(a)))a=a.substring(d[0].length),d=b=c(d[1]),g+=this.renderer.link(d,null,b);else if(d=this.rules.tag.exec(a))!this.inLink&&
/^<a /i.test(d[0])?this.inLink=!0:this.inLink&&/^<\/a>/i.test(d[0])&&(this.inLink=!1),a=a.substring(d[0].length),g+=this.options.sanitize?this.options.sanitizer?this.options.sanitizer(d[0]):c(d[0]):d[0];else if(d=this.rules.link.exec(a))a=a.substring(d[0].length),this.inLink=!0,g+=this.outputLink(d,{href:d[2],title:d[3]}),this.inLink=!1;else if((d=this.rules.reflink.exec(a))||(d=this.rules.nolink.exec(a)))a=a.substring(d[0].length),b=(d[2]||d[1]).replace(/\s+/g," "),(b=this.links[b.toLowerCase()])&&
b.href?(this.inLink=!0,g+=this.outputLink(d,b),this.inLink=!1):(g+=d[0].charAt(0),a=d[0].substring(1)+a);else if(d=this.rules.strong.exec(a))a=a.substring(d[0].length),g+=this.renderer.strong(this.output(d[1]||d[2]));else if(d=this.rules.mark.exec(a))a=a.substring(d[0].length),g+=this.renderer.mark(this.output(d[1]));else if(d=this.rules.underline.exec(a))a=a.substring(d[0].length),g+=this.renderer.underline(this.output(d[1]));else if(d=this.rules.em.exec(a))a=a.substring(d[0].length),g+=this.renderer.em(this.output(d[2]||
d[1]));else if(d=this.rules.math.exec(a))a=a.substring(d[0].length),g+=this.renderer.math(d[1]);else if(d=this.rules.code.exec(a))a=a.substring(d[0].length),g+=this.renderer.codespan(c(d[2],!0));else if(d=this.rules.br.exec(a))a=a.substring(d[0].length),g+=this.renderer.br();else if(d=this.rules.del.exec(a))a=a.substring(d[0].length),g+=this.renderer.del(this.output(d[1]));else if(d=this.rules.text.exec(a))a=a.substring(d[0].length),g+=this.renderer.text(c(this.smartypants(d[0])));else if(a)throw Error("Infinite loop on byte: "+
a.charCodeAt(0));return g};h.prototype.outputLink=function(a,g){var b=c(g.href),d=g.title?c(g.title):null;return"!"!==a[0].charAt(0)?this.renderer.link(b,d,this.output(a[1])):this.renderer.image(b,d,c(a[1]))};h.prototype.smartypants=function(a){return this.options.smartypants?a.replace(/---/g,"\u2014").replace(/--/g,"\u2013").replace(/(^|[-\u2014/(\[{"\s])'/g,"$1\u2018").replace(/'/g,"\u2019").replace(/(^|[-\u2014/(\[{\u2018\s])"/g,"$1\u201c").replace(/"/g,"\u201d").replace(/\.{3}/g,"\u2026"):a};
h.prototype.mangle=function(a){if(!this.options.mangle)return a;for(var g="",b=a.length,d=0,c;d<b;d++)c=a.charCodeAt(d),.5<Math.random()&&(c="x"+c.toString(16)),g+="&#"+c+";";return g};b.prototype.code=function(a,g,b){if(this.options.highlight){var d=this.options.highlight(a,g);null!=d&&d!==a&&(b=!0,a=d)}return g?'<pre><code class="'+this.options.langPrefix+c(g,!0)+'">'+(b?a:c(a,!0))+"\n</code></pre>\n":"<pre><code>"+(b?a:c(a,!0))+"\n</code></pre>"};b.prototype.blockquote=function(a){return"<blockquote>\n"+
a+"</blockquote>\n"};b.prototype.html=function(a){return a};b.prototype.heading=function(a,b,c){return"<h"+b+' id="'+this.options.headerPrefix+c.toLowerCase().replace(/[^\w]+/g,"-")+'">'+a+"</h"+b+">\n"};b.prototype.hr=function(){return this.options.xhtml?"<hr/>\n":"<hr>\n"};b.prototype.list=function(a,b){var c=b?"ol":"ul";return"<"+c+">\n"+a+"</"+c+">\n"};b.prototype.listitem=function(a){return"<li>"+a+"</li>\n"};b.prototype.paragraph=function(a){return"<p>"+a+"</p>\n"};b.prototype.table=function(a,
b){return"<table>\n<thead>\n"+a+"</thead>\n<tbody>\n"+b+"</tbody>\n</table>\n"};b.prototype.tablerow=function(a){return"<tr>\n"+a+"</tr>\n"};b.prototype.tablecell=function(a,b){var c=b.header?"th":"td";return(b.align?"<"+c+' style="text-align:'+b.align+'">':"<"+c+">")+a+"</"+c+">\n"};b.prototype.strong=function(a){return"<strong>"+a+"</strong>"};b.prototype.mark=function(a){return"<mark>"+a+"</mark>"};b.prototype.underline=function(a){return"<u>"+a+"</u>"};b.prototype.em=function(a){return"<em>"+
a+"</em>"};b.prototype.codespan=function(a){return"<code>"+a+"</code>"};b.prototype.br=function(){return this.options.xhtml?"<br/>":"<br>"};b.prototype.math=function(a){try{return katex.renderToString(a)}catch(b){return a}};b.prototype.del=function(a){return"<del>"+a+"</del>"};b.prototype.link=function(a,b,c){if(this.options.sanitize){try{var d=decodeURIComponent(t(a)).replace(/[^\w:]/g,"").toLowerCase()}catch(f){return""}if(0===d.indexOf("javascript:")||0===d.indexOf("vbscript:"))return""}a=a.replace(/&quot;|&#39;/gi,
"");d='<a href="'+a+'"';/^(?!javascript:|vbscript:|#)/.test(a)&&(d+=' target="__blank"');b&&(d+=' title="'+b+'"');return d+(">"+c+"</a>")};b.prototype.image=function(a,b,c){var d=/(?:\/([\s\S]+)\/)?\s*(?:w:(\d+))?\s*(?:h:(\d+))?\s*(?:w:(\d+))?/.exec(b),f,e;d&&0<d[0].length&&(b=d[1],f=d[2]||d[4],e=d[3]);a='<img src="'+a+'" alt="'+c+'"';b&&(a+=' title="'+b+'"');a+=' style="';f&&(a+="width:"+f+"px;");e&&(a+="height:"+e+"px;");return a=a+'"'+(this.options.xhtml?"/>":">")};b.prototype.text=function(a){return a};
b.prototype.handseq=function(a){$container=$("<div>"+a+"</div>");$container.sequenceDiagram();return $("<div></div>").append($container.clone()).html()};b.prototype.flowchart=function(a){try{var b=flowchart.parse(a),c=$('<div id="zmd-inner-flowchart" style="display:none;"></div>');$("body").append(c);b.drawSVG("zmd-inner-flowchart",{x:0,y:0,"line-width":2,"line-length":30,"text-margin":10,"font-size":14,"font-color":"black","line-color":"black","element-color":"rgb(108, 108, 108)",fill:"white","yes-text":"yes",
"no-text":"no","arrow-end":"block",scale:1,symbols:{start:{"font-color":"red","element-color":"rgb(108, 108, 108)",fill:"yellow"},end:{"class":"end-element"}},flowstate:{past:{fill:"#CCCCCC","font-size":12},current:{fill:"rgb(236, 236, 255)","font-color":"red","font-weight":"bold"},future:{fill:"rgb(236, 236, 255)"},request:{fill:"blue"},invalid:{fill:"#444444"},approved:{fill:"#58C4A3","font-size":12,"yes-text":"APPROVED","no-text":"n/a"},rejected:{fill:"#C45879","font-size":12,"yes-text":"n/a",
"no-text":"REJECTED"}}});var d=c.html();c.remove();return d}catch(f){return a}};b.prototype.mermaid=function(a){return'<div class="mermaid">'+a+"</div>"};b.prototype.bootalert=function(a,b){return'<div class="alert alert-'+a+'">'+b+"</div>"};b.prototype.katex=function(a){try{var b=a.split(/\n{2,}/),c="",d;for(d in b)c+=katex.renderToString(b[d]);return c}catch(f){return a}};f.parse=function(a,b,c){return(new f(b,c)).parse(a)};f.prototype.parse=function(a){this.inline=new h(a.links,this.options,this.renderer);
this.tokens=a.reverse();for(a="";this.next();)a+=this.tok();return a};f.prototype.next=function(){return this.token=this.tokens.pop()};f.prototype.peek=function(){return this.tokens[this.tokens.length-1]||0};f.prototype.parseText=function(){for(var a=this.token.text;"text"===this.peek().type;)a+="\n"+this.next().text;return this.inline.output(a)};f.prototype.tok=function(){switch(this.token.type){case "space":return"";case "hr":return this.renderer.hr();case "heading":return this.renderer.heading(this.inline.output(this.token.text),
this.token.depth,this.token.text);case "code":return this.renderer.code(this.token.text,this.token.lang,this.token.escaped);case "table":var a="",b="",c,d,f,e;f="";for(c=0;c<this.token.header.length;c++)f+=this.renderer.tablecell(this.inline.output(this.token.header[c]),{header:!0,align:this.token.align[c]});a+=this.renderer.tablerow(f);for(c=0;c<this.token.cells.length;c++){d=this.token.cells[c];f="";for(e=0;e<d.length;e++)f+=this.renderer.tablecell(this.inline.output(d[e]),{header:!1,align:this.token.align[e]});
b+=this.renderer.tablerow(f)}return this.renderer.table(a,b);case "blockquote_start":for(b="";"blockquote_end"!==this.next().type;)b+=this.tok();return this.renderer.blockquote(b);case "list_start":b="";for(a=this.token.ordered;"list_end"!==this.next().type;)b+=this.tok();return this.renderer.list(b,a);case "list_item_start":for(b="";"list_item_end"!==this.next().type;)b+="text"===this.token.type?this.parseText():this.tok();return this.renderer.listitem(b);case "loose_item_start":for(b="";"list_item_end"!==
this.next().type;)b+=this.tok();return this.renderer.listitem(b);case "html":return b=this.token.pre||this.options.pedantic?this.token.text:this.inline.output(this.token.text),this.renderer.html(b);case "paragraph":return this.renderer.paragraph(this.inline.output(this.token.text));case "text":return this.renderer.paragraph(this.parseText());case "handseq":return this.renderer.handseq(this.token.text);case "flowchart":return this.renderer.flowchart(this.token.text);case "katex":return this.renderer.katex(this.token.text);
case "mermaid":return this.renderer.mermaid(this.token.text);case "bootalert":return this.renderer.bootalert(this.token.style,this.inline.output(this.token.text))}};q.exec=q;n.options=n.setOptions=function(a){u(n.defaults,a);return n};n.defaults={gfm:!0,tables:!0,breaks:!1,pedantic:!1,sanitize:!1,sanitizer:null,mangle:!0,smartLists:!1,silent:!1,highlight:null,langPrefix:"lang-",smartypants:!1,headerPrefix:"",renderer:new b,xhtml:!1};n.Parser=f;n.parser=f.parse;n.Renderer=b;n.Lexer=k;n.lexer=k.lex;
n.InlineLexer=h;n.inlineLexer=h.output;n.parse=n;"undefined"!==typeof module&&"object"===typeof exports?module.exports=n:"function"===typeof define&&define.amd?define(function(){return n}):this.marked=n}).call(function(){return this||("undefined"!==typeof window?window:global)}());
function ZmdEditor(k,h){var b=h.contentName?h.contentName:"zmd-content",f=h.contentId?h.contentId:"zmd-content",c=$('<div id="zmd-inner-editor" class="zmd-inner-editor"></div>'),t=$('<textarea name="'+b+'" id="'+f+'" class="zmd-inner-content"></textarea>'),p=$('<div id="zmd-inner-preview" class="zmd-outer-content"></div>');c.append(t);c.append(p);this.textarea=t[0];this.preview=p[0];this.typedSomething=!0;var q=this,b=$('<div id="zmd-inner-actions" class="zmd-inner-actions"></div>');this.fillActions(b,
h.actions);k.append(b);k.append(c);this.initScroll();marked.setOptions({highlight:function(b){return hljs.highlightAuto(b).value}});var u;t.on("keyup",function(){q.typedSomething=!0;clearTimeout(u);u=setTimeout(function(){var b=q.preview.scrollTop;p.html(marked(t.val()));mermaid.init(void 0,".mermaid");q.preview.scrollTop=b},1E3)})}
ZmdEditor.prototype.initScroll=function(){var k=this,h=0,b=0,f=this.textarea,c=this.preview;$(f).scroll(function(){setTimeout(function(){c.scrollTop=(f.scrollTop-h)/(f.scrollHeight-f.clientHeight)*(c.scrollHeight-c.clientHeight)+b;h=f.scrollTop;b=c.scrollTop;k.typedSomething=!1},k.typedSomething?500:100)})};
ZmdEditor.prototype.fillActions=function(k,h){var b=this,f=[];f.push({item:'<i class="material-icons" title="\u7c97\u4f53">format_bold</i>',action:function(){b.insert("**","**")}});f.push({item:'<i class="material-icons" title="\u659c\u4f53">format_italic</i>',action:function(){b.insert("*","*")}});f.push({item:'<i class="material-icons" title="\u5220\u9664\u7ebf">format_strikethrough</i>',action:function(){b.insert("~~","~~")}});f.push({item:'<i class="material-icons" title="\u4e0b\u5212\u7ebf">format_underlined</i>',
action:function(){b.insert("++","++")}});f.push({item:'<i class="material-icons" title="\u9ad8\u4eae">highlight</i>',action:function(){b.insert("==","==")}});f.push({item:'<i class="material-icons" title="\u5f15\u7528">format_quote</i>',action:function(){b.insert("\n>","")}});f.push({item:'<i class="material-icons" title="\u884c\u5185\u4ee3\u7801">code</i>',action:function(){b.insert("`","`")}});f.push({item:'<i class="material-icons" title="\u4ee3\u7801\u5757">developer_mode</i>',action:function(){b.insertLineStart("    ")}});
f.push({item:'<i class="material-icons" title="\u8868\u683c">grid_on</i>',action:function(){b.insert("\nheader 1 | header 2\n---|---\nrow 1 col 1 | row 1 col 2\nrow 2 col 1 | row 2 col 2\n\n","")}});f.push({item:'<span title="\u4ec5\u9996\u5b57\u6bcd\u5927\u5199">Aa</span>',action:function(){b.selectionCase(3)}});f.push({item:'<span title="\u9009\u4e2d\u90e8\u5206\u5168\u90e8\u8f6c\u4e3a\u5927\u5199">AA</span>',action:function(){b.selectionCase(1)}});f.push({item:'<span title="\u9009\u4e2d\u90e8\u5206\u5168\u90e8\u8f6c\u4e3a\u5c0f\u5199">aa</span>',
action:function(){b.selectionCase(2)}});f.push({item:'<i class="material-icons" title="\u63d2\u5165\u56fe\u7247">insert_photo</i>',action:function(){b.insert("![image](https://github.com/fluidicon.png)","")}});f.push({item:'<i class="material-icons" title=h1">looks_one</i>',action:function(){b.header(1)}});f.push({item:'<i class="material-icons" title=h2">looks_two</i>',action:function(){b.header(2)}});f.push({item:'<i class="material-icons" title=h3">looks_3</i>',action:function(){b.header(3)}});
f.push({item:'<i class="material-icons" title=h4">looks_4</i>',action:function(){b.header(4)}});f.push({item:'<i class="material-icons" title=h5">looks_5</i>',action:function(){b.header(5)}});f.push({item:'<i class="material-icons" title=h6">looks_6</i>',action:function(){b.header(6)}});f.push({item:'<i class="material-icons" title="\u6a2a\u7ebf">remove</i>',action:function(){b.insert("\n---\n","")}});f.push({item:'<i class="material-icons" title="\u8d85\u94fe\u63a5">insert_link</i>',action:function(){b.insert('[example]("http://example.org")',
"")}});f.push({item:'<i class="material-icons" title="\u65e0\u5e8f\u5217\u8868">format_list_bulleted</i>',action:function(){b.insertList(!1)}});f.push({item:'<i class="material-icons" title="\u6709\u5e8f\u5217\u8868">format_list_numbered</i>',action:function(){b.insertList(!0)}});f.push({item:'<i class="material-icons" title="\u6570\u5b66\u516c\u5f0f">functions</i>',action:function(){b.insert("```\nmath\nc = \\pm\\sqrt{a^2 + b^2}\n```\n","")}});f.push({item:'<i class="material-icons" title="\u6d41\u7a0b\u56fe">show_chart</i>',
action:function(){b.insert("```\ngraph TD;\n    A--\x3eB;\n    A--\x3eC;\n    B--\x3eD;\n    C--\x3eD;\n```\n","")}});f.push({item:'<i class="material-icons" title="\u65f6\u5e8f\u56fe">short_text</i>',action:function(){b.insert("```\nsequenceDiagram\n    participant John\n    participant Alice\n    Alice->>John: Hello John, how are you?\n    John--\x3e>Alice: Great!\n```\n","")}});f.push({item:'<i class="material-icons" title="\u7518\u7279\u56fe">tune</i>',action:function(){b.insert("```\ngantt\n    title A Gantt Diagram\n\n    section Section\n    A task           :a1, 2014-01-01, 30d\n \r\n    Another task     :after a1  , 20d\n    section Another\n    Task in sec      :2014-01-12  , 12d\n    anther task      : 24d\n```\n",
"")}});if(Array.isArray(h))for(var c=0;c<h.length;c++)f.push(h[c]);f.push({item:'<i class="material-icons" title="\u4e0b\u8f7dPDF">file_download</i>',action:function(){$print=$('<div class="zmd-outer-content"></div>');$print.html($(b.preview).html());$print.css("width","100%");var c={mode:"popup",popClose:"true",popWd:.8*$("body").width()+"px",popX:.1*$("body").width()+"px",popY:"100px",retainAttr:["id","class","style"],extraHead:'<meta charset="utf-8" />,<meta http-equiv="X-UA-Compatible" content="IE=edge"/>'};
$print.printArea(c)}});for(c in f)if(f[c].item&&f[c].action){var t=$('<button type="button" idx="'+c+'">'+f[c].item+"</button>");t.click(function(){f[$(this).attr("idx")].action(b)});k.append(t)}};ZmdEditor.prototype.isNewLineChar=function(k){return"\r"==k||"\n"==k};ZmdEditor.prototype.insert=function(k,h){var b=this.textarea,f=$(b),c=b.selectionStart,t=b.selectionEnd,p=f.val();this.replaceSelection(k+p.substring(c,t)+h);b.setSelectionRange(c+k.length,t+k.length);f.keyup()};
ZmdEditor.prototype.insertLineStart=function(k){for(var h=this.textarea,b=$(h),f=h.selectionStart,c=h.selectionEnd,t=b.val(),p=f;0<p&&!this.isNewLineChar(t[p-1]);)p--;h.setSelectionRange(p,p);this.replaceSelection(k);h.setSelectionRange(f+k.length,c+k.length);b.keyup()};
ZmdEditor.prototype.insertList=function(k){for(var h=this.textarea,b=$(h),f=0,c=h.selectionStart,t=h.selectionEnd,p=b.val(),q=c;0<q&&!isNewLineChar(p[q-1]);)q--;var u=q,n="";0==q&&(++f,n=n+(k?f+". ":"- ")+p[q],q++);for(;q<t;)!isNewLineChar(p[q])&&isNewLineChar(p[q-1])&&(++f,n+=k?f+". ":"- "),n+=p[q],q++;h.setSelectionRange(u,q);replaceSelection(n);h.setSelectionRange(c+(k?3:2),t+f*(k?3:2));b.keyup()};
ZmdEditor.prototype.selectionCase=function(k){var h=this.textarea,b=$(h),f=h.selectionStart,c=h.selectionEnd,t=b.val();switch(k){case 1:replaceSelection(t.substring(f,c).toUpperCase());break;case 2:replaceSelection(t.substring(f,c).toLowerCase());break;case 3:replaceSelection(t.substring(f,f+1).toUpperCase()+t.substring(f+1,c).toLowerCase())}h.setSelectionRange(f,c);b.keyup()};ZmdEditor.prototype.header=function(k){for(var h="",b=0;b<k;b++)h+="#";this.insertLineStart(h+" ")};
ZmdEditor.prototype.replaceSelection=function(k){var h=this.textarea,b=$(h),f=h.selectionStart,h=h.selectionEnd,c=b.val();b.focus();document.queryCommandSupported("insertText")?document.execCommand("insertText",!1,k):b.val(c.substring(0,f)+k+c.substring(h))};$.fn.zmdEditor=function(k){return new ZmdEditor($(this),k)};$.fn.renderMarked=function(k){$(this).html(marked(k));mermaid.init(void 0,".mermaid")};
